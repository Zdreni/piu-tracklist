...
function ApplyUnlocks()
{
	...
	// 1.00
		...
		Lock( "Wedding Crashers", "D22", "Advanced Lv. 5 Title" )
		...
		Lock( "Nyarlathotep", "D20", "Advanced Lv. 1 Title" )
		Lock( "Nyarlathotep", "D23", "Advanced Lv. 9 Title" )
	...
	// 1.02
		Lock( "Time for the moon night", "S18", "at least A+ on S16" )
		Lock( "Time for the moon night", "D21", "at least A+ on D18" )

		Lock( "Gashina", "S18", "at least S on S14" )
		Lock( "Gashina", "D19", "at least A+ on S18 and S on D15" )

		Lock( "Rage of fire", "S18", "at least A+ on S16" )
		Lock( "Rage of fire", "D19", "at least A+ on D17" )

		Lock( "You and I", "S21", "at least A+ on Chase Me S20 + Good Night S20 + Fly High S18" )
		Lock( "You and I", "D20", "at least A+ on Chase Me D18 + Good Night D19 + Fly High D19" )
		Lock( "You and I", "D25", "at least A+ on Chase Me D23 + Good Night D22 + Good Night D24" )

		Lock( "1949", "S21", "at least A+ on S16 and 1950 S20" )
		Lock( "1949", "S23", "at least A+ on 1950 S23, then randomize it" )

		Lock( "Meteo5cience", "S21", "at least A+ on Mad5cience S20 + Meteorize S17 + Meteo5cience S18" )
		Lock( "Meteo5cience", "D22", "at least A+ on Mad5cience D16 + Meteorize D18 + Meteo5cience D19" )
	...
	// 1.03
		...
		Lock( "Can-Can ~Orpheus in the Party Mix~", "S22", "at least S on Can Can radzetsky S16" )
		Lock( "Can-Can ~Orpheus in the Party Mix~", "D23", "at least S on Can Can radzetsky D17" )

		Lock( "Papasito (ft. KuTiNA)", "S20", "at least S on S15 and A on S16" )
		Lock( "Papasito (ft. KuTiNA)", "D21", "at least S on D16 and A on D18" )

		Lock( "Fires of Destiny", "S20", "at least S on S16 and A on S18" )
		Lock( "Fires of Destiny", "D22", "at least S on D11 and A on D18" )

		Lock( "Forgotten Vampire", "S18", "at least S on S13 and A on S16" )
		Lock( "Forgotten Vampire", "D20", "at least S on D14 and A on D17" )
