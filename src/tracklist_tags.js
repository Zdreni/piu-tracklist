...
const DRILLS = "#drills"
const DRILLS_PLUS = "#drills.plus"
const JACKS = "#jacks"
const FOOTSWITCHES = "#footswitches"
const FOOTSWITCHES_PLUS = "#footswitches.plus"
const TIGHT_HOLDS = "#tight_holds"  // where holds start close to each other
...
export function ApplyTags( tracklist )
{
	...
	{
		AddSimpleTags( tracklist, tags.join(" "), charts );
	}
	...
	T('17__After_Like  S18',  TWISTS, FOOTSWITCHES)


	T('17__Airplane  S17',  TWISTS, STAIRS)


	T('17__Alice_in_Misanthrope  S20/D21/S22',  BRACKETS)
	T('17__Alice_in_Misanthrope  S22',  GIMMICKS_BLINKING)
	...
	T('15__Allegro_Furioso  S18',  TWISTS_BACK)
	T('15__Allegro_Furioso  S20',  JACKS)


	T('14__Allegro_Piu_Mosso  S17/S19',  TWISTS)
	T('14__Allegro_Piu_Mosso  S17',  FOOTSWITCHES)
	T('14__Allegro_Piu_Mosso  S19',  BRACKETS)


	T('17__Alone  S17',  TWISTS)
	T('17__Alone  D18',  WIDE_RUNS, TWISTS)


	T('17__Altale  S21/D23',  BRACKETS)


	T('17__Amor_Fati  S18',  STEP_HOLD, TRIPLES)
	T('17__Amor_Fati  S21/D23',  STEP_HOLD)
	T('17__Amor_Fati  D23',  BRACKETS, WIDE_RUNS)
	...
	T('15__Anguished_Unmaking  S18',  TWISTS)
	...
	//not on Phoenix:  T('0D__Arch_of_Darkness  S17',  GIMMICKS_VELOCITY)
	T('0D__Arch_of_Darkness  S17',  JUMPS)


	T('10__Arirang  D15',  WIDE_RUNS_PLUS)
	T('10__Arirang  S19/S22',  TWISTS)
	T('10__Arirang  S22',  JACKS)


	T('15__Arcana_Force  S20',  TWISTS)


	T('15__Asterios_ReEntry  S17/S19',  TWISTS)
	...
	T('10__B_P_Classic_Remix  S14',  TWISTS)
	T('10__B_P_Classic_Remix  D15',  WIDE_RUNS)


	T('14__Bad_Apple  D11',  WIDE_RUNS)
	T('14__Bad_Apple  S15',  MEMORIZE, GIMMICKS_STOPS)
	T('14__Bad_Apple  S17',  TWISTS)
	T('14__Bad_Apple  D18',  TWISTS)
	T('14__Bad_Apple  S19/D20',  TWISTS_BACK)
	T('14__Bad_Apple  D20',  STEP_HOLD)


	T('14__Bad_Apple__FULL  S14/S17',  TWISTS)
	...
	T('13__Baroque_Virus  S10/D18',  TWISTS)
	T('13__Baroque_Virus  D18/D20',  WIDE_RUNS)
	T('13__Baroque_Virus  D20',  TWISTS_BACK)

	//not on Phoenix: T('16__Baroque_Virus__FULL  S15',  GIMMICKS_VELOCITY)
	T('16__Baroque_Virus__FULL  S15',  STEP_HOLD)

	T('0C__Beat_of_the_War_2  D15',  WIDE_RUNS)
	T('0C__Beat_of_the_War_2  S21',  FOOTSWITCHES_PLUS)


	//T('0E__Beat_the_Ghost  S20',  BRUTEFORCE)
	//not on Phoenix: T('0E__Beat_the_Ghost  S20',  SLOWDOWN)


	T('17__Beautiful_Liar  D18',  WIDE_RUNS, BRACKETS)
	...
	T('05__Beethoven_Virus  S16',  TWISTS)
	...
	T('10__Bemera__SHORT  S15',  TWISTS_BACK)
	T('10__Bemera__SHORT  S22',  JACKS)


	T('04__Betrayer  S16',  TWISTS)
	...
	T('17__Boca  D19',  BRACKETS)
	T('17__Boca  S21/D23',  BRACKETS, JUMPS)
	T('17__Boca  D23',  WIDE_RUNS)
	...
	T('15__Bring_Back_the_Beat  S12/D19',  TWISTS)
	T('15__Bring_Back_the_Beat  D19',  WIDE_RUNS)
	...
	T('16__Can_Can_Orpheus  S21',  BRACKETS)

	T('16__Can_Can_Orpheus__SHORT  D15',  WIDE_RUNS_PLUS)


	T('0F__Cannon_X_1  D15',  WIDE_RUNS)
	T('0F__Cannon_X_1  D15/S21',  TWISTS)
	...
	T('16__Carmen_Bus  S21',  TWISTS, STAMINA)


	T('17__Catastrophe  S12',  TWISTS)


	T('17__Chaos_Again  S15/D17/S18',  GIMMICKS_VELOCITY)
	T('17__Chaos_Again  S21',  MEMORIZE, GIMMICKS_STOPS)


	T('09__Chicken_Wing  S17/S20/D22',  DRILLS)
	T('09__Chicken_Wing  D22',  BRACKETS)

	T('10__Chicken_Wing__SHORT  D15', WIDE_RUNS)
	...
	//not on Phoenix: T('14__Chinese_Restaurant  S18/D19',  SLOWDOWN)


	T('0F__Chopsticks_Challenge  S12',  TWISTS)
	T('0F__Chopsticks_Challenge  S17',  TWISTS)
	//not on Phoenix: T('0F__Chopsticks_Challenge  S17',  SLOWDOWN)

	T('0F__Chopsticks_Challenge__FULL  S17',  TWISTS)


	T('16__Clematis_Rapsodia  S18',  TWISTS)
	T('16__Clematis_Rapsodia  S22',  TWISTS)
	T('16__Clematis_Rapsodia  S22/D23',  BRACKETS)
	...
	T('15__Clue  S18',  TWISTS)
	T('15__Clue  D20',  TWISTS_BACK, GIMMICKS_VELOCITY)
	T('15__Clue  D21',  TWISTS_BACK, TWISTS_QUAD)
	...
	T('16__Cross_Ray  D14',  WIDE_RUNS)


	T('15__Cross_Time  D22',  MEMORIZE, GIMMICKS_STOPS, TWISTS)


	T('16__Crossing_Delta  D14',  WIDE_RUNS)
	T('16__Crossing_Delta  S20',  TWISTS, BRACKETS)
	...
	T('17__Dead_End  S21/D22/S23',  BRACKETS)


	T('15__Death_Moon  S19',  TWISTS, STAMINA)
	...
	T('10__Destination  D15/D20',  WIDE_RUNS)
	T('10__Destination  D15/S17/D20',  TWISTS)
	T('10__Destination  D20',  STRETCH, JACKS)
	...
	T('0A__Dignity  D17',  WIDE_RUNS_PLUS)
	T('0A__Dignity  D20',  WIDE_RUNS)


	T('16__District_1  S19',  TWISTS)
	...
	T('17__Duel  S18',  TWISTS)
	T('17__Duel  S21',  TWISTS_BACK)


	T('17__Duel__SHORT  S19',  TWISTS, STAIRS)
	T('17__Duel__SHORT  S21',  TWISTS_PLUS)


	T('13__Elise  S18',  TWISTS, DRILLS)


	T('17__Emomomo  D21',  WIDE_RUNS, TWISTS, STEP_HOLD)
	...
	T('17__Euphorianic  D21',  WIDE_RUNS)


	T('11__Everybody_Got_2_Know  S21',  MEMORIZE, GIMMICKS_STOPS)


	T('02__Extravaganza  D15/D21',  WIDE_RUNS)
	T('02__Extravaganza  D18',  WIDE_RUNS_PLUS, JUMPS)
	T('02__Extravaganza  S19/D21',  DRILLS)
	...
	T('17__Festival_of_Death_Moon  S18',  TWISTS, STEP_HOLD)


	T('02__Final_Audition  S18.Phoenix',  TWISTS)
	...
	//not on Phoenix: T('0F__Final_Audition_ep_2_X  D21',  SLOWDOWN)
	T('0F__Final_Audition_ep_2_X  D21',  WIDE_RUNS)
	T('0F__Final_Audition_ep_2_X  D24',  RUNS_AS_BRACKETS)


	T('16__Fire_Noodle_Challenge  S15',  TWISTS)
	...
	T('16__Fly_High  D21',  BRACKETS)


	T('13__Follow_Me  S14',  EXOTIC_CENTRALHOLD)
	...
	T('16__Gloria  S20/D21',  DRILLS, BRACKETS)
	T('16__Gloria  D21',  SLOWDOWN)
	...
	T('15__Gothique_Resonance  S18',  STAMINA)
	T('15__Gothique_Resonance  S20/D20',  TWISTS_SIDE)


	T('17__Goodbounce  S20',  BRACKETS)


	T('17__Goodtek  S21',  BRACKETS, TWISTS)


	T('0E__Guitar_Man  D19',  WIDE_RUNS)


	T('0D__Gun_Rock  S20',  TRIPLES, JUMPS)
	T('0D__Gun_Rock  D18',  DRILLS)


	T('17__Halcyon  S22',  TWISTS)


	T('17__Halloween_Party_Multiverse  S18',  TWISTS)
	...
	T('15__Helix  S18/S19/D19',  TWISTS)
	T('15__Helix  D19',  WIDE_RUNS)
	...
	T('15__Hey_U  D16',  JUMPS)


	T('0E__Higgledy_Piggledy  D20',  TWISTS, WIDE_RUNS)


	T('15__HTTP  D13/D19',  WIDE_RUNS)


	T('17__Hymn_of_Golden_Glory  D25',  BRACKETS)

	T('17__Hymn_of_Golden_Glory__SHORT  S15',  JUMPS)
	...
	//not on Phoenix: T('13__Hypnosis_SynthWulf_Mix  D22',  GIMMICKS_VELOCITY)
	T('13__Hypnosis_SynthWulf_Mix  D22',  JACKS, WIDE_RUNS, TWISTS, BRACKETS)


	T('16__I_Want_U  S17',  TWISTS, STAMINA)
	...
	//not on Phoenix: T('16__Ice_of_Death  S17',  GIMMICKS)
	T('16__Ice_of_Death  S20',  TWISTS, GIMMICKS_BLINKING)


	T('14__Idealized_Romance  S18',  TWISTS)
	//not on Phoenix:  T('14__Idealized_Romance  D18',  SLOWDOWN)
	T('14__Idealized_Romance  D18',  WIDE_RUNS)


	T('13__Ignis_Fatuus  D18',  STRETCH)
	T('13__Ignis_Fatuus  D18/D23',  WIDE_RUNS)


	T('16__Imagination  D16/S19/D21',  TWISTS_BACK)
	T('16__Imagination  S18',  EXOTIC_CENTRALHOLD)
	T('16__Imagination  D21',  WIDE_RUNS, DRILLS)
	...
	T('16__Janus  D14',  TWISTS, WIDE_RUNS)
	...
	T('15__Kill_Them  S18',  TWISTS)
	T('15__Kill_Them  D19',  TWISTS_QUAD)


	T('16__Kimchi_Fingers  S14',  EXOTIC_TURN_AROUND)
	...
	T('16__La_Cinquantaine  S22.Phoenix',  BRACKETS, TWISTS)
	...
	T('12__Ladybug  S14',  TWISTS)


	T('15__Last_Rebirth  D18',  JACKS)


	T('14__Latino_Virus  D13/D19',  WIDE_RUNS)


	T('15__Le_Grand_Bleu  S18/S20',  TWISTS)
	T('15__Le_Grand_Bleu  S20',  DRILLS, JACKS)


	T('16__Le_Grand_Rouge  S20',  TWISTS_PLUS, STAMINA)
	...
	T('16__Life_is_Piano  S19/D18/D21',  TWISTS)
	T('16__Life_is_Piano  D21',  WIDE_RUNS)
	...
	T('16__Loki  S20/D20/S21',  GIMMICKS_BLINKING)
	T('16__Loki  S20',  TWISTS)
	T('16__Loki  S21',  FOOTSWITCHES_PLUS)


	T('07__Love_is_a_Danger_Zone  S17/S19',  TWISTS)
	T('07__Love_is_a_Danger_Zone  D17',  WIDE_RUNS)


	T('0C__Love_is_a_Danger_Zone_2  S15',  TWISTS)


	T('0C__Love_is_a_Danger_Zone_2_DnG  S17.Phoenix',  TWISTS_SIDE)
	...
	T('17__Lucid_Dream  S21',  BRACKETS)
	...
	T('14__Matador  D22',  TWISTS_QUAD, STAMINA)
	...
	T('14__Meteorize  S18',  BRACKETS, TWISTS)


	T('14__Milky_Way_Galaxy  S18',  TWISTS)
	...
	T('14__Move_That_Body  S17/D18',  TWISTS)
	T('14__Move_That_Body  D18',  WIDE_RUNS)
	T('14__Move_That_Body  S20',  TWISTS_PLUS)
	...
	T('11__Native  S17/D18/S20',  FOOTSWITCHES, JACKS)
	...
	T('11__Night_Duty  S17',  TWISTS, JUMPS)
	...
	T('16__Nyarlathotep  S18',  FOOTSWITCHES)
	...
	T('16__Over_the_Horizon  S17',  TWISTS)
	T('16__Over_the_Horizon  S20',  FOOTSWITCHES)


	T('11__Overblow  S20',  DRILLS)

	T('11__Overblow__SHORT  D17',  WIDE_RUNS)
	T('11__Overblow__SHORT  S18',  TWISTS)


	T('15__Overblow2  S18',  TWISTS)
	...
	T('13__Pop_the_Track  S18',  TWISTS)
	...
	T('14__Prime_Opening__SHORT  D15',  JUMPS)


	T('15__Prime2_Opening__SHORT  S17',  TWISTS)


	T('05__Pump_Jump  S15',  STAIRS)
	...
	T('10__Pumping_Jumping  D18',  WIDE_RUNS)
	...
	T('16__Rage_of_Fire  D17/D19',  WIDE_RUNS)
	T('16__Rage_of_Fire  S20',  TWISTS_PLUS)
	...
	T('15__Rave_til_the_Earth_End  D18',  TWISTS, WIDE_RUNS)
	...
	T('14__Red_Swan  D12',  STRETCH, TIGHT_HOLDS)
	...
	T('15__Redline  D20',  WIDE_RUNS)


	T('14__Reminiscence  S18',  TWISTS, STAMINA)
	...
	T('14__Requiem  S19',  TWISTS)
	T('14__Requiem  D23',  STAMINA, WIDE_RUNS)
	...
	//not on Phoenix: T('14__Rock_the_House  D18',  SLOWDOWN)
	T('14__Rock_the_House  D18',  DRILLS)
	...
	T('15__Sarabande  S19',  TWISTS, TRIPLES, BRACKETS)
	...
	T('14__Selfishness  D18',  WIDE_RUNS)
	...
	T('03__She_Likes_Pizza  D18',  WIDE_RUNS)


	T('17__Showdown  S20',  BRACKETS)
	T('17__Showdown  D22',  BRACKETS_PLUS)
	...
	T('14__Silhouette_Effect__SHORT  D17',  DRILLS_PLUS)


	T('17__Simon_Says_Eurodance  S20',  TWISTS_PLUS)


	T('05__Slam  S18.Phoenix',  JUMPS)
	...
	T('16__Slapstick_Parfait  S19/D21',  TWISTS)
	T('16__Slapstick_Parfait  D21',  WIDE_RUNS)


	T('14__Smile_Diary  S19',  TWISTS)


	T('17__Solfeggietto  S19',  STAMINA)
	...
	T('04__Solitary  S17.Phoenix/S18',  TWISTS)
	//not on Phoenix:  T('04__Solitary  S17.Phoenix/S18',  GIMMICKS_STOPS)
	...
	T('0B__Solitary_2  S18',  STAMINA, TWISTS)
	T('0B__Solitary_2  D20',  STAMINA, TWISTS, WIDE_RUNS)
	...
	T('17__Stardream_Eurobeat_Remix  S19',  TWISTS)


	T('17__Stardream_Eurobeat_Remix__SHORT  S18/D20',  JUMPS)
	T('17__Stardream_Eurobeat_Remix__SHORT  D20',  STRETCH)
	...
	T('17__Sudden_Appearance_Image  S19/S21',  BRACKETS, TWISTS)
	T('17__Sudden_Appearance_Image  D23',  BRACKETS_PLUS)


	T('14__Sudden_Romance  S14',  TWISTS)
	...
	T('16__Sugar_Plum  D20',  JUMPS, JACKS, WIDE_RUNS)
	...
	T('14__Super_Fantasy  S19',  TWISTS, STAMINA)
	T('14__Super_Fantasy  S20',  TWISTS_BACK, STAMINA, GIMMICKS_BLINKING)
	T('14__Super_Fantasy  D22',  TWISTS_BACK, WIDE_RUNS, STAMINA)


	T('17__Sweet_Wonderland  S20',  TWISTS, STAMINA)


	T('16__Switronic  S17',  TWISTS)
	T('16__Switronic  D18',  TWISTS_BACK, WIDE_RUNS)
	T('16__Switronic  D22',  GIMMICKS_BLINKING)


	T('16__Switronic__SHORT  S17/D17',  GIMMICKS_BLINKING)
	T('16__Switronic__SHORT  S17',  TWISTS)
	...
	T('15__The_Festival_of_Ghost2  S18',  TWISTS)
	...
	T('07__Till_the_End_of_Time  S17',  TWISTS_BACK, ROLLING_BRACKETS)


	T('16__Timing  D19',  WIDE_RUNS)


	T('0F__Toccata  D15',  WIDE_RUNS)
	...
	T('0B__Tream_Vook_of_the_War  D17',  WIDE_RUNS, TWISTS_BACK)


	T('15__Travel_to_Future  S11',  TWISTS)
	...
	T('17__Trickl4sh_220  S21',  BRACKETS)


	T('16__Tropicanic  S19/D21',  TWISTS)


	T('11__Trotpris__SHORT  D15',  STRETCH)


	T('03__Turkey_March  S17',  JACKS)
	T('03__Turkey_March  S19',  TWISTS)
	T('03__Turkey_March  D21',  WIDE_RUNS_PLUS, JUMPS)


	T('10__Turkey_March_Minimal_Tunes  S17',  TWISTS_SIDE, GIMMICKS_VELOCITY)
	...
	T('14__Yog_Sothoth__SHORT  S14',  TWISTS)  
	T('14__Yog_Sothoth__SHORT  D16',  TWISTS_BACK)  


	T('14__Yoropiku_Pikuyoro  S22',  DRILLS)
	...
	T('13__U_Got_Me_Rocking__SHORT  D17',  TWISTS, WIDE_RUNS)


	T('0D__Ugly_Dee  S17',  MEMORIZE)


	T('0F__Ugly_Duck_Toccata  S17',  TWISTS)
	...
	T('15__Utsushiyo_No_Kaze  S17',  JUMPS)
	T('15__Utsushiyo_No_Kaze  D20',  TWISTS_QUAD)


	T('15__V3  S14',  JACKS)
	//not on Phoenix:  T('15__V3  D21',  SLOWDOWN)
	T('15__V3  D21',  WIDE_RUNS)
	...
	T('12__VVV  D17/D19/S23',  SLOWDOWN, GIMMICKS_VELOCITY)
	T('12__VVV  S23',  TWISTS)


	T('15__Waltz_of_Doge  S14',  EXOTIC_TURN_AROUND)
	...
	T('16__Wicked_Legend  S20',  TWISTS, JACKS, GIMMICKS_STOPS)
	...
	T('0C__Witch_Doctor  D19',  DRILLS)


	T('10__Witch_Doctor__SHORT  S14',  EXOTIC_TURN_AROUND)


	T('0D__Witch_Doctor_1  S17.Phoenix',  TWISTS)
	T('0D__Witch_Doctor_1  S18.Phoenix/S19/D21.Phoenix',  TWISTS_BACK)
	T('0D__Witch_Doctor_1  D17',  TWISTS_QUAD)
	T('0D__Witch_Doctor_1  D20',  WIDE_RUNS, TWISTS_BACK, BRACKETS)


	T('11__We_Got_2_Know  D18',  TWISTS_BACK)


	T('11__What_Happened  D20',  BRACKETS)
	T('11__What_Happened  D23',  BRACKETS_PLUS)


	T('17__Whisper  D18',  WIDE_RUNS)
	...
	T('10__X_Tree  D16/D22',  WIDE_RUNS)


	T('0A__X_Treme  S18',  TWISTS)


	T('16__Xeroize  D18/D22',  WIDE_RUNS)
	T('16__Xeroize  S21/D22',  TWISTS_BACK)
	T('16__Xeroize  D22',  STRETCH, BRACKETS)


	T('13__Yeo_Rae_A  S13',  SLOWDOWN);


	T('14__You_again_my_love  S14',  TWISTS)
	...
	T('14__You_Got_Me_Crazy  S18',  TWISTS)
